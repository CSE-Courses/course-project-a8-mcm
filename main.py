    ...
    async def mainScreen(self):
       ...
       # calls method to initalize fonts
        ...
        while True:
            ...
            if self.autoFill != "":
                autoFillText = autoFillFont.render(
                    (self.autoFill + "?"), True, [192, 192, 192])
